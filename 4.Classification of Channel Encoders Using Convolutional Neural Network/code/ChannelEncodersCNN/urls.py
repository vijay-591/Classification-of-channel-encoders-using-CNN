"""WeaponDetection URL Configuration
...
urlpatterns = [
    ...
    path("sampleencodestring/", usr.sampleencodestring, name="sampleencodestring"),
    path("cnnModelTest/", usr.cnnModelTest, name='cnnModelTest'),
